...
insert into positions values (1, "manager"), (2, "employee");

insert into levels values (1, "intermediate"), (2, "college"), (3, "university"), (4, "postgraduate");

insert into departments values (1, "Sale-Marketing"), (2, "Hành chính"), (3, "Phục vụ"), (4, "Quản lý");

insert into employees (employee_code, employee_name, employee_dob, employee_idCard, employee_salary, employee_phone, employee_email, employee_address, position_code, level_code, department_code)
values
	(1, "Nguyễn Văn An", "1970-11-07", "456231786", 10000000, "0901234121", "annguyen@gmail.com", "295 Nguyễn Tất Thành, Đà Nẵng", 1, 3, 1),
	(2, "Lê Văn Bình", "1997-04-09", "654231234", 7000000, "0934212314", "annguyen@gmail.com", "22 Yên Bái, Đà Nẵng", 1, 2, 2),
...
insert into customers (customer_code, customer_name, customer_dob, customer_gender, customer_idCard, customer_phone, customer_email, customer_address, customerType_code)
values 
...
insert into rentTypes values (1, "year"), (2, "month"), (3, "day"), (4, "hour");

insert into serviceTypes values (1, "Villa"), (2, "House"), (3, "Room");

insert into services (service_code, service_name,service_area, service_rentFee, service_maxCustomer, service_standardRoom, service_descriptionOtherAmenities, service_poolArea, service_floorNumber, rentType_code, serviceType_code)
values 
...
insert into accompaniedServices values
...
insert into contractDetails values
	(1, 5, 2, 4),
    (2, 8, 2, 5),
    (3, 15, 2, 6),
    (4, 1, 3, 1),
